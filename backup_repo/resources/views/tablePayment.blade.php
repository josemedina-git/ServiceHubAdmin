    ...
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
        ...
        <div class="container-fluid py-2">
                    ...
                    <div class="card my-4 shadow-lg border-0">
                        <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                            <div class="bg-gradient-dark shadow-dark border-radius-lg pt-4 pb-3">
                                <h6 class="text-white text-capitalize ps-3">Tabla de Pagos</h6>
                            </div>
                        </div>
                        ...
                        <script>
                            ...
                            function filterUsers(searchTerm) {
                                return usuarios.filter(usuario => {
                                    return usuario.factura.toString().includes(searchTerm.toLowerCase());
                                });
                            }
                            ...
                            const usuarios = [
                                { factura: 'FAC001', suscripcion: 'Gratis', estado: 'Pagado', importe: 0, metodoPago: 'N/A' },
                                { factura: 'FAC002', suscripcion: 'Mensual', estado: 'Pendiente', importe: 100, metodoPago: 'Tarjeta debito/credito' },
                                { factura: 'FAC003', suscripcion: 'Anual', estado: 'Vencido', importe: 900, metodoPago: 'Paypal' },
                                { factura: 'FAC004', suscripcion: 'Mensual', estado: 'Pagado', importe: 100, metodoPago: 'Tarjeta debito/credito' },
                                { factura: 'FAC005', suscripcion: 'Gratis', estado: 'Vencido', importe: 0, metodoPago: 'N/A' },
                                { factura: 'FAC006', suscripcion: 'Anual', estado: 'Pagado', importe: 900, metodoPago: 'Paypal' },
                                { factura: 'FAC007', suscripcion: 'Mensual', estado: 'Pendiente', importe: 100, metodoPago: 'Paypal' },
                                { factura: 'FAC008', suscripcion: 'Mensual', estado: 'Pendiente', importe: 100, metodoPago: 'Tarjeta debito/credito' },
                                { factura: 'FAC009', suscripcion: 'Anual', estado: 'Cancelado', importe: 900, metodoPago: 'Tarjeta debito/credito' },
                                { factura: 'FAC010', suscripcion: 'Gratis', estado: 'Cancelado', importe: 0, metodoPago: 'N/A' },
                                { factura: 'FAC011', suscripcion: 'Anual', estado: 'Cancelado', importe: 900, metodoPago: 'Paypal' },
                                { factura: 'FAC012', suscripcion: 'Mensual', estado: 'Pagado', importe: 100, metodoPago: 'Tarjeta debito/credito' },
                                { factura: 'FAC013', suscripcion: 'Gratis', estado: 'Cancelado', importe: 0, metodoPago: 'N/A' },
                                { factura: 'FAC014', suscripcion: 'Mensual', estado: 'Vencido', importe: 100, metodoPago: 'Paypal' },
                                { factura: 'FAC015', suscripcion: 'Anual', estado: 'Pendiente', importe: 900, metodoPago: 'Tarjeta debito/credito' }
                            ];
            ...
            <tr> 
                ...
                <a href="{{ route('paymentForm') }}" class="btn btn-info">Editar</a>
                </td>
