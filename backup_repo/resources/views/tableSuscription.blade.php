    ...
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
        ...
        <div class="container-fluid py-2">
                    ...
                    <div class="card my-4 shadow-lg border-0">
                        <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                            <div class="bg-gradient-dark shadow-dark border-radius-lg pt-4 pb-3">
                                <h6 class="text-white text-capitalize ps-3">Tabla de Suscripciones</h6>
                            </div>
                        </div>
                        ...
                        <div class="card-body px-4 pb-4">
                            ...
                            <div class="row mb-4">
                                ...
                                <div style="margin-top: 15px;">
                                    <a href="{{ route('suscriptionForm') }}" class="btn btn-info">Agregar</a>
                                </div>
                            </div>
                        </div>
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 text-center"
                                                    onclick="sortTable(2)">
                                                    Fecha de inicio <span class="material-symbols-rounded arrow"
                                                        id="arrow-dateStart">expand_more</span>
                                                </th>
                                                <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7"
                                                    onclick="sortTable(3)">
                                                    Fecha de expiración <span class="material-symbols-rounded arrow"
                                                        id="arrow-dateEnd">expand_more</span>
                                                </th>
                                                <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 text-center"
                                                    onclick="sortTable(4)">
                                                    Tipo de suscripción <span class="material-symbols-rounded arrow"
                                                        id="arrow-suscripcion">expand_more</span>
                                                </th>
                                                <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 text-center"
                                                    onclick="sortTable(5)">
                                                    Status <span class="material-symbols-rounded arrow"
                        ...
                        <script>
                            ...
                            function filterUsers(searchTerm) {
                                return usuarios.filter(usuario => {
                                    return usuario.profesional.toLowerCase().includes(searchTerm.toLowerCase())
                            ...
                            function sortTable(columnIndex) {
                                let direction = 1;
                                const arrow = document.querySelector(`#arrow-${['id', 'profesional', 'dateStart', 'dateEnd', 'suscripcion', 'estado'][columnIndex]}`);
                            ...
                            const usuarios = [
                                { id: 1, profesional: 'Jonh Cena', dateStart: '2024-01-01', dateEnd: '2024-12-31', suscripcion: 'anual', estado: 'activa' },
                                { id: 2, profesional: 'Ana Gómez', dateStart: '2024-03-15', dateEnd: '2024-06-15', suscripcion: 'mensual', estado: 'activa' },
                                { id: 3, profesional: 'Juan Pérez', dateStart: '2024-02-01', dateEnd: '2024-02-28', suscripcion: 'gratis', estado: 'expirada' },
                                { id: 4, profesional: 'Laura Sánchez', dateStart: '2024-05-01', dateEnd: '2025-04-30', suscripcion: 'anual', estado: 'activa' },
                                { id: 5, profesional: 'Miguel Torres', dateStart: '2023-12-01', dateEnd: '2024-11-30', suscripcion: 'anual', estado: 'expirada' },
                                { id: 6, profesional: 'Sofía Ramírez', dateStart: '2024-07-01', dateEnd: '2024-07-31', suscripcion: 'gratis', estado: 'activa' },
                                { id: 7, profesional: 'Luis Rojas', dateStart: '2024-06-01', dateEnd: '2024-06-30', suscripcion: 'mensual', estado: 'expirada' },
                                { id: 8, profesional: 'Patricia Vargas', dateStart: '2024-08-01', dateEnd: '2024-08-31', suscripcion: 'mensual', estado: 'activa' },
                                { id: 9, profesional: 'José García', dateStart: '2023-10-01', dateEnd: '2024-09-30', suscripcion: 'anual', estado: 'expirada' },
                                { id: 10, profesional: 'Elena Castro', dateStart: '2024-09-01', dateEnd: '2024-09-30', suscripcion: 'gratis', estado: 'expirada' },
                                { id: 11, profesional: 'Roberto Núñez', dateStart: '2024-05-15', dateEnd: '2024-08-15', suscripcion: 'mensual', estado: 'activa' },
                                { id: 12, profesional: 'Fernanda López', dateStart: '2024-11-01', dateEnd: '2025-10-31', suscripcion: 'anual', estado: 'activa' },
                                { id: 13, profesional: 'Rafael Castillo', dateStart: '2024-03-01', dateEnd: '2024-03-31', suscripcion: 'gratis', estado: 'expirada' },
                                { id: 14, profesional: 'Natalia Reyes', dateStart: '2024-04-01', dateEnd: '2024-06-30', suscripcion: 'mensual', estado: 'activa' },
                                { id: 15, profesional: 'Andrés Molina', dateStart: '2024-07-15', dateEnd: '2024-08-14', suscripcion: 'mensual', estado: 'expirada' }
                            ];
            ...
            <tr>
                ...
                <td class="text-xs font-weight-bold mb-0">${usuario.profesional}</td>
                <td class="text-xs font-weight-bold mb-0">${usuario.dateStart}</td>
                <td class="text-xs font-weight-bold mb-0">${usuario.dateEnd}</td>
                ...
                <td class="align-middle">
                                    <a href="{{ route('suscriptionForm') }}" class="btn btn-info">Editar</a>
