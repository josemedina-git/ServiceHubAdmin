    ...
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
        ...
        <div class="container-fluid py-2">
                    ...
                    <div class="card my-4 shadow-lg border-0">
                        <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                            <div class="bg-gradient-dark shadow-dark border-radius-lg pt-4 pb-3">
                                <h6 class="text-white text-capitalize ps-3">Tabla de Métodos de Pagos</h6>
                            </div>
                        </div>
                        ...
                        <div class="card-body px-4 pb-4">
                            ...
                            <div class="row mb-4">
                                ...
                                <div style="margin-top: 15px;">
                                    <a href="{{ route('typePayment') }}" class="btn btn-info">Agregar</a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 text-center"
                                                    onclick="sortTable(2)">
                                                    Entidad <span class="material-symbols-rounded arrow"
                                                        id="arrow-entity">expand_more</span>
                                                </th>
                                                <th
                        ...
                        <script>
                            ...
                            function sortTable(columnIndex) {
                                let direction = 1;
                                const arrow = document.querySelector(`#arrow-${['id', 'metodoPago', 'entity'][columnIndex]}`);
                            ...
                            const usuarios = [
                                { id: 1, metodoPago: 'Tarjeta debito/credito', entity: 'BBVA México' },
                                { id: 2, metodoPago: 'Tarjeta debito/credito', entity: 'Banorte' },
                                { id: 3, metodoPago: 'Paypal', entity: 'Plataforma de pagos electrónicos' },
                                { id: 4, metodoPago: 'Tarjeta debito/credito', entity: 'Santander México' },
                                { id: 5, metodoPago: 'Tarjeta debito/credito', entity: 'HSBC México' },
                                { id: 6, metodoPago: 'Tarjeta debito/credito', entity: 'Banco Azteca' },
                                { id: 7, metodoPago: 'Tarjeta debito/credito', entity: 'Inbursa' },
                                { id: 8, metodoPago: 'Tarjeta debito/credito', entity: 'Banco del Bajío' },
                                { id: 9, metodoPago: 'Tarjeta debito/credito', entity: 'Afirme' },
                                { id: 10, metodoPago: 'Tarjeta debito/credito', entity: 'Banco Sabadell México' },
                                { id: 11, metodoPago: 'Tarjeta debito/credito', entity: 'Banregio' },
                                { id: 12, metodoPago: 'Tarjeta debito/credito', entity: 'Banco Famsa' },
                                { id: 13, metodoPago: 'Tarjeta debito/credito', entity: 'Consubanco' },
                                { id: 14, metodoPago: 'Tarjeta debito/credito', entity: 'CIBanco' }
                            ];
            ...
            <tr> 
                ...
                <td class="text-xs font-weight-bold mb-0">${usuario.entity}</td>

                <td class="align-middle">
                                    <a href="{{ route('typePayment') }}" class="btn btn-info">Editar</a>
