    ...
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
        ...
        <div class="container-fluid py-2">
                    ...
                    <div class="row">
                                            ...
                                            <tr>
                                                ...
                                                <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 text-center"
                                                    ...
                                                    Nombre <span class="material-symbols-rounded arrow"
                                                        id="arrow-name">expand_more</span>
                                                </th>
                                                <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 text-center"
                                                    onclick="sortTable(2)">
                        ...
                        <script>
                            ...
                            function sortTable(columnIndex) {
                                let direction = 1;
                                const arrow = document.querySelector(`#arrow-${['id', 'name', 'descripcion'][columnIndex]}`);
                            ...
                            const usuarios = [
                                { id: 1, name: 'Jardinería', descripcion: 'Servicios de mantenimiento de jardines y áreas verdes.' },
                                { id: 2, name: 'Plomería', descripcion: 'Servicios de reparación e instalación de tuberías.' },
                                { id: 3, name: 'Electricidad', descripcion: 'Servicios de instalación y mantenimiento eléctrico.' },
                                { id: 4, name: 'Carpintería', descripcion: 'Servicios de fabricación y reparación de muebles.' },
                                { id: 5, name: 'Pintura', descripcion: 'Servicios de pintura interior y exterior.' },
                                { id: 6, name: 'Limpieza', descripcion: 'Servicios de limpieza para hogares y oficinas.' },
                                { id: 7, name: 'Cerrajería', descripcion: 'Servicios de apertura y cambio de cerraduras.' },
                                { id: 8, name: 'Fontanería', descripcion: 'Servicios de reparación de sistemas de fontanería.' },
                                { id: 9, name: 'Albañilería', descripcion: 'Servicios de construcción y reparación de estructuras.' },
                                { id: 10, name: 'Mudanzas', descripcion: 'Servicios de transporte y mudanza de bienes.' },
                                { id: 11, name: 'Mecánica', descripcion: 'Servicios de reparación y mantenimiento de vehículos.' },
                                { id: 12, name: 'Tecnología', descripcion: 'Servicios de reparación e instalación de equipos tecnológicos.' },
                                { id: 13, name: 'Climatización', descripcion: 'Servicios de instalación y reparación de sistemas de aire acondicionado.' },
                                { id: 14, name: 'Reparación de electrodomésticos', descripcion: 'Servicios de mantenimiento y reparación de electrodomésticos.' },
                                { id: 15, name: 'Fumigación', descripcion: 'Servicios de control de plagas para viviendas y negocios.' }
                            ];
            ...
            <tr>
                ...
                <td class="text-xs font-weight-bold mb-0">${usuario.name}</td>
                <td class="text-center text-xs font-weight-bold mb-0">${usuario.descripcion}</td>

                <td class="align-middle">
                                    <a href="{{ route('categoryForm') }}" class="btn btn-info">Editar</a>
