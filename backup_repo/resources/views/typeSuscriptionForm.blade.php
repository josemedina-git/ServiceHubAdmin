                    ...
                    <div class="card my-4 shadow-lg border-0">
                        <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                            <div class="bg-gradient-dark shadow-dark border-radius-lg pt-4 pb-3">
                                <h6 class="text-white text-capitalize ps-3">Agregar Suscripción</h6>
                            </div>
                        </div>
                                        ...
                                        <form id="formulario" onsubmit="mostrarConfirmacion(event)">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea id="comentarios" class="form-control" rows="4"
                                                    placeholder="Describe tu Suscripción aquí..."></textarea>
                                            </div>
                        ...
                        <div id="confirmacionModal" class="modal-overlay" style="display: none;">
                            <div class="card modal-card">
                                <div class="card-body">
                                    ...
                                    <p class="card-text text-center">El tipo de suscripción ha sido agregada con éxito.</p>
                                </div>
                            </div>
                        </div>
                    </div>
