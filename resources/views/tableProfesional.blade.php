    ...
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
        ...
        <div class="container-fluid py-2">
                    ...
                    <div class="card my-4 shadow-lg border-0">
                        <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                            <div class="bg-gradient-dark shadow-dark border-radius-lg pt-4 pb-3">
                                <h6 class="text-white text-capitalize ps-3">Tabla de Profesionales</h6>
                            </div>
                        </div>
                        ...
                        <div class="card-body px-4 pb-4">
                            ...
                            <div class="row mb-4">
                                ...
                                <div style="margin-top: 15px;">
                                    <a href="{{ route('profesionalForm') }}" class="btn btn-info">Agregar</a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <script>
                            ...
                            function sortTable(columnIndex) {
                                let direction = 1;
                                const arrow = document.querySelector(`#arrow-${['id', 'profesional', 'curp', 'rfc', 'experiencia', 'disponibilidad'][columnIndex]}`);
            ...
            <tr>
                ...
                <td class="text-xs font-weight-bold mb-0">${usuario.curp}</td>
                <td class="text-xs font-weight-bold mb-0">${usuario.rfc}</td>
                <td class="text-center text-xs font-weight-bold mb-0">${usuario.experiencia}</td>
                <td class="text-center text-xs font-weight-bold mb-0">${usuario.disponibilidad}</td>

                <td class="align-middle">
                                    <a href="{{ route('profesionalForm') }}" class="btn btn-info">Editar</a>
