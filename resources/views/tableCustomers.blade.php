...
@include('layouts.partials.aside')
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
        ...
        <div class="container-fluid py-2">
                        ...
                        <div class="card-body px-4 pb-4">
                            ...
                            <div class="row mb-4">
                                ...
                                <div style="margin-top: 15px;">
                                    <a href="{{ route('clientForm') }}" class="btn btn-info">Agregar</a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <script>
                            ...
                            function sortTable(columnIndex) {
                                let direction = 1;
                                const arrow = document.querySelector(`#arrow-${['id', 'nombre', 'apellidos', 'email', 'telefono', 'fecha'][columnIndex]}`);
            ...
            <tr>
                ...
                <td class="text-center text-xs font-weight-bold mb-0">${usuario.apellidos}</td>
                <td class="text-center text-xs font-weight-bold mb-0">${usuario.email}</td>
                <td class="text-center text-xs font-weight-bold mb-0">${usuario.telefono}</td>
                <td class="text-center text-xs font-weight-bold mb-0">${usuario.fechaRegistro}</td>
                <td class="align-middle">
                                    <a href="{{ route('clientForm') }}" class="btn btn-info">Editar</a>
    ...
    `;
                            ...
                            //  wuuuuuuuuuuuuuuuu Función para cambiar de página
