...
@include('layouts.partials.aside')
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
    ...
    <div class="container py-4">
      <h2 class="text-center">Bitácora de Movimientos</h2>
