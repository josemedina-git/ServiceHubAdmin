    ...
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
                    ...
                    <div class="card my-4 shadow-lg border-0">
                        <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                            <div class="bg-gradient-dark shadow-dark border-radius-lg pt-4 pb-3">
                                <h6 class="text-white text-capitalize ps-3">Tabla de Agendas</h6>
                            </div>
                        </div>
                        ...
                        <div class="card-body px-4 pb-4">
                            ...
                            <div class="row mb-4">
                                ...
                                <div style="margin-top: 15px;">
                                    <a href="{{ route('agendaForm') }}" class="btn btn-info">Agregar</a>
                                </div>
                            </div>
                        </div>
                                        ...
                                        <thead>
                                            <tr>
                                                <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7"
                                                    onclick="sortTable(0)">
                                                    Id Agenda<span class="material-symbols-rounded arrow"
                                                ...
                                                <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 text-center"
                                                    onclick="sortTable(3)">
                                                    Fecha Agendada <span class="material-symbols-rounded arrow"
        ...
        @endforeach
                        ...
                        <script>
                            ...
                            function filterUsers(searchTerm) {
                                return usuarios.filter(usuario => {
                                    return usuario.nameCliente.toLowerCase().includes(searchTerm.toLowerCase());
                                });
                            }
                            ...
                            function sortTable(columnIndex) {
                                let direction = 1;
                                const arrow = document.querySelector(`#arrow-${['id', 'nameCliente', 'servicio', 'fecha', 'estado'][columnIndex]}`);
            ...
            <tr>
                ...
                <td class="text-xs font-weight-bold mb-0">${usuario.nameCliente}</td>
                <td class="text-center text-xs font-weight-bold mb-0">${usuario.servicio}</td>
                ...
                <td class="align-middle">
                    <a href="{{ route('agendaForm') }}" class="btn btn-info">Editar</a>
