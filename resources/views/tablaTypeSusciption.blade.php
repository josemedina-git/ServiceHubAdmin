                    ...
                    <div class="card my-4 shadow-lg border-0">
                        <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                            <div class="bg-gradient-dark shadow-dark border-radius-lg pt-4 pb-3">
                                <h6 class="text-white text-capitalize ps-3">Tabla de tipos de suscripciones</h6>
                            </div>
                        </div>
                        ...
                        <div class="card-body px-4 pb-4">
                            ...
                            <div class="row mb-4">
                                ...
                                <div style="margin-top: 15px;">
                                    <a href="{{ route('typeSuscriptionForm') }}" class="btn btn-info">Agregar</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 text-center"
                                                onclick="sortTable(2)">
                                                Descripcion <span class="material-symbols-rounded arrow"
                                                    id="arrow-descripcion">expand_more</span>
                                            </th>
                                            <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7"
                                                onclick="sortTable(3)">
                                                Precio <span class="material-symbols-rounded arrow"
                        ...
                        <script>
                            ...
                            function sortTable(columnIndex) {
                                let direction = 1;
                                const arrow = document.querySelector(`#arrow-${['id', 'name', 'descripcion', 'price'][columnIndex]}`);
                            ...
                            const usuarios = [
                                { id: 1, name: 'Gratis', descripcion: 'Acceso limitado sin costo.', price: 0 },
                                { id: 2, name: 'Mensual', descripcion: 'Acceso completo durante un mes.', price: 100 },
                                { id: 3, name: 'Anual', descripcion: 'Acceso completo durante un año.', price: 900 }
                            ];
                                ...
                                recordsToShow.forEach(usuario => {
                                    const row = `
                                        <tr> 
                                            ...
                                            <td class="text-xs font-weight-bold mb-0">${usuario.price}</td>
