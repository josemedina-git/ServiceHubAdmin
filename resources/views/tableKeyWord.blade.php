    ...
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
        ...
        <div class="container-fluid py-2">
                        ...
                        <div class="card-body px-4 pb-4">
                            ...
                            <div class="row mb-4">
                                ...
                                <div style="margin-top: 15px;">
                                    <a href="{{ route('keyWordForm') }}" class="btn btn-info">Agregar</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <script>
                            ...
                            function filterUsers(searchTerm) {
                                return usuarios.filter(usuario => {
                                    return usuario.keyWord.toLowerCase().includes(searchTerm.toLowerCase());
                                });
                            }
                            ...
                            function sortTable(columnIndex) {
                                let direction = 1;
                                const arrow = document.querySelector(`#arrow-${['id', 'keyWord', 'categoria'][columnIndex]}`);
            ...
            <tr>
                ...
                <td class="text-xs font-weight-bold mb-0">${usuario.keyWord}</td>
                <td class="text-center text-xs font-weight-bold mb-0">${usuario.categoria}</td>

                <td class="align-middle">
                                    <a href="{{ route('keyWordForm') }}" class="btn btn-info">Editar</a>
