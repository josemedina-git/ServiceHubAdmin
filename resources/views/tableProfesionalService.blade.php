        ...
        <div class="container-fluid py-2">
                    ...
                    <div class="card my-4 shadow-lg border-0">
                        <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                            <div class="bg-gradient-dark shadow-dark border-radius-lg pt-4 pb-3">
                                <h6 class="text-white text-capitalize ps-3">Tabla de Servicios del Profesional</h6>
                            </div>
                        </div>
                        ...
                        <div class="card-body px-4 pb-4">
                            ...
                            <div class="row mb-4">
                                ...
                                <div style="margin-top: 15px;">
                                    <a href="{{ route('profesionalServiceForm') }}" class="btn btn-info">Agregar</a>
                                </div>
                            </div>
                        </div>
            ...
            <tr>
                ...
                <td class="align-middle">
                                    <a href="{{ route('profesionalServiceForm') }}" class="btn btn-info">Editar</a>
