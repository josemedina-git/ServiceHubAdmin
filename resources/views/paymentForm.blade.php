...
@include('layouts.partials.aside')
          ...
          <div class="card my-4 shadow-lg border-0">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              <div class="bg-gradient-dark shadow-dark border-radius-lg pt-4 pb-3">
                <h6 class="text-white text-capitalize ps-3">Agregar Pago</h6>
              </div>
            </div>
          ...
          <div class="container d-flex justify-content-center">
            <div class="row justify-content-center">
              <div class="col-md-12">
                ...
                <div class="card">
                  <div class="card-body">
                    <h5 class="card-title text-center mb-4">Formulario de Pagos</h5>
                    <form id="formulario" onsubmit="mostrarConfirmacion(event)">
                      <!-- Profesional: Campo editable -->
                      <div class="form-row">
                        <div class="form-group col-md-4 me-4">
                          <label for="cliente" class="text-black fw-bold me-6">Factura</label>
                          <input type="text" class="form-control custom-input" id="importe" placeholder="FAC001"
                            readonly>
                        </div>

                        <!-- Suscripción: Campo editable pero influye en el importe -->
                        <div class="form-group col-md-4">
                          <label for="sus" class="text-black fw-bold">Suscripción</label>
                          <input type="text" class="form-control custom-input" id="importe" placeholder="Mensual"
                            readonly>
                        </div>
                      </div>

                      <!-- Importe: Campo de solo lectura -->
                      <div class="form-row">
                        <div class="form-group col-md-6">
                          <label for="importe" class="text-black fw-bold">Importe</label>
                          <input type="text" class="form-control custom-input" id="importe" placeholder="$100"
                            readonly>
                        </div>
                      </div>

                      <!-- Método de Pago: Campo editable -->
                      <div class="form-row">
                        <div class="form-group col-md-4">
                          <label for="metodoPago" class="text-black fw-bold">Método De Pago</label>
                          <input type="text" class="form-control custom-input" id="importe" placeholder="Tarjeta de Crédito"
                            readonly>
                        </div>
                      </div>

                      <!-- Status: Campo editable con opciones controladas -->
                      <div class="form-row">
                        <div class="form-group col-md-4">
                          <label for="status" class="text-black fw-bold">Status</label><br>
                          <select id="status" class="lista">
                    ...
                    <script>
                      // Bloquear la edición de "Importe"
                      document.getElementById("importe").readOnly = true;

                      // Ejemplo de cálculo del importe basado en la suscripción seleccionada
                      function calcularImporte() {
                        const suscripcion = document.getElementById("sus").value;
                        ...
                        switch (suscripcion) {
                          case "gratis":
                            ...
                            break;
                          case "mensual":
                            importeInput.value = "$100";
                            break;
                          case "anual":
                            importeInput.value = "$900";
                            break;
                          default:
                            importeInput.value = ""; // Valor vacío si no se selecciona ninguna opción válida
                        }
                      }

                      // Mostrar una confirmación al enviar el formulario
            ...
            <div id="confirmacionModal" class="modal-overlay" style="display: none;">
              <div class="card modal-card">
                <div class="card-body">
                  ...
                  <p class="card-text text-center">El pago ha sido agregada con éxito.</p>
                </div>
              </div>
            </div>
          </div>
  ...
  <script>
    function calcularImporte() {
      // Obtener el valor de la suscripción seleccionada
      const suscripcion = document.getElementById('sus').value;
      const importeInput = document.getElementById('importe');

      // Calcular el importe según la suscripción seleccionada
      let importe = 0;
      switch (suscripcion) {
        case 'gratis':
          importe = 0;
      ...
      // Actualizar el campo de importe con el valor calculado
